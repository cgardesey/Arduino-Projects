...
// Phant public key:
const char publicKey[] = "XGyR1y8KvaSE9bKoYznb";
// Phant private key:
const char privateKey[] = "1JY9qYj50KslR7MmbYp7";
...
void postToPhant()
{
  ...
  // using integers.
  phant.add(F("battery_level"), 3);
  phant.add(F("humidity"), 4);
  phant.add(F("light_level"), 5);
  phant.add(F("pressure"), 6);
  phant.add(F("temp_c"), 7);
  phant.add(F("temp_f"), 8);
