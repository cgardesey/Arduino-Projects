...
void sendToThingspeak()
{
  ...
  Serial.println("GET http://api.thingspeak.com/update?key=W68QUVX7MAZT3NXY&field1=" + String(winddir) +"&field2=" + String(windspeedmph) + "&field3=" +String(humidity)+ "&field4=" +String(tempf)+ "&field5=" +String(pressure)+ "&field6=" +String(light_lvl)+ "&field7=" +String(rainin));
  delay(4000);
