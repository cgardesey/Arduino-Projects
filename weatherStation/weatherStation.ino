...
void postToPhant()
{
  ...
  gprs.print("AT+ZIPSEND");
  delay(4000);
 
  gprs.print("GET http://api.thingspeak.com/update?key=GSU96L72FD1JBLK2&field1=" + String(winddir) +"&field2=" + String(windspeedmph) + "&field3=" +String(windgustmph)+"&field4=" + String(windgustdir) + "&field5=" +String(humidity)+ "&field6=" + String(tempf) + "&field7=" +String(rainin)+ "&field8=" + String(pressure));
  delay(5000);
  gprs.print((char)26);
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
